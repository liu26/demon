...
<head>
	...
	<!-- 放大镜插件 -->
	<link rel="stylesheet" type="text/css" href="/Public/Zmplus/magiczoomplus.css">
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
					<?php foreach ($relationData as $k => $v): ?>
						<li>
							<dl>
								<dt><a href="<?php echo U('Index/detail', array('goods_id' => $v['id']));?>"><img src="<?php echo C("VIEW_ROOT_PATH") . $v['goods_thumb'];?>" alt="" /></a></dt>
								<dd><a href="<?php echo U('Index/detail', array('goods_id' => $v['id']));?>"><?php echo $v['goods_name'];?></a></dd>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					<?php foreach ($sessionData as $k => $v): ?>
						<dl>
							<dt><a target="_blank" href="<?php echo U('Index/detail', array('goods_id' => $v['id']));?>"><img src="<?php echo C('VIEW_ROOT_PATH') . $v['goods_thumb'];?>" alt="" /></a></dt>
							<dd><a target="_blank" href="<?php echo U('Index/detail', array('goods_id' => $v['id']));?>"><?php echo $v['goods_name'];?></a></dd>
						</dl>
					<?php endforeach ?>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
					<!-- 插件 放大镜 -->
					<a href="<?php echo C('VIEW_ROOT_PATH') . $goodsInfo['goods_img'];?>" class="MagicZoomPlus">
				   <img src="<?php echo C('VIEW_ROOT_PATH').$row['goods_img'];?>" alt="" /> 
					</a>
					</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?php echo $rows['goods_sn'];?></li>
						<li class="market_price"><span>定价：</span><em>￥ <?php echo $rows['goods_price'];?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥ <?php echo $rows['goods_price'];?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?php echo date('Y-m-d', $rows['add_time']);?></li>
	...
	<script type="text/javascript" src="/Public/Zmplus/magiczoomplus.js"></script>
</body>
</html>