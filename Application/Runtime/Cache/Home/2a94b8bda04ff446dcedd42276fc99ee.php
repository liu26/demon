		...
		<div class="nav w1210 bc mt10">
			...
			<div class="category fl"> <!-- 非首页，需要添加cat1类 -->
				...
				<div class="cat_bd">
					<?php foreach ($rows as $k => $v): ?>
						...
						<div class="cat item1">
						<!-- 伪静态开启 -->
							<h3><a target="_blank" href="<?php echo U('Index/category',array('id'=>$v['id']));?>"><?php echo $v['cate_name'];?></a> <b></b></h3>
							<div class="cat_detail">
							<?php foreach ($v['child'] as $key => $value): ?>
								<dl class="dl_1st">
									<dt><a target="_blank" href="<?php echo U('Index/category',array('id'=>$value['id']));?>"><?php echo $value['cate_name'];?></a></dt>
									<dd>
									<?php foreach ($value['child'] as $k1 => $v1): ?>
										<a target="_blank" href="<?php echo U('Index/category',array('id'=>$v1['id']));?>"><?php echo $v1['cate_name'];?></a>
									<?php endforeach ?>
									</dd>
								</dl>
							<?php endforeach ?>
			...
			<div class="navitems fl">
				<ul class="fl">
					...
					<li><a href="<?php echo $v['url']?$v['url']:U('Index/category',array('id'=>$v['id']));?>"><?php echo $v['cate_name'];?></a></li>
					<?php endforeach;?>
				</ul>
				...
				<div class="hot none">
					<ul>
						<?php foreach ($hotData as $k => $v): ?>
							...
							<li>
								<dl>
									<dt><a href="<?php echo U('Index/detail', array('id' => $v['id']));?>"><img src="<?php echo C('VIEW_ROOT_PATH') . $v['goods_thumb'];?>" alt="" /></a></dt>
									<dd><a href="<?php echo U('Index/detail', array('id' => $v['id']));?>"><?php echo $v['goods_name'];?></a></dd>
									<dd><span>售价：</span><strong> ￥ <?php echo $v['goods_price'];?></strong></dd>
								</dl>
							</li>
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						...
						<li><a href=""><img src="/Public/home/images/d.gif" alt="" /></a></li>
