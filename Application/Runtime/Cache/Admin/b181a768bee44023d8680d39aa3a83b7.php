        ...
        <div id="user_login">
            <dl>
                <dd id="user_top">
                    ...
                    <form action="/index.php/Admin/Text/login" method="POST">
                        <ul>
                            ...
                            <li class="user_main_c">
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            <input class="TxtPasswordCssClass" id="admin_psd" name="passwd" type="password">
                                        </li>
                                    </ul>
                                    <!--<ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="<?php echo U('Back/code')?>" onclick="this.src='/index.php/Admin/Text/code/' +Math.random();"  alt="" />
                                        </li>
                                    </ul>-->
                                </div>
                            </li>
