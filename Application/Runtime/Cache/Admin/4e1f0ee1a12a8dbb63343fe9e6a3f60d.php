...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <form action="/index.php/Admin/user/add" method="POST" enctype="multipart/form-data" id='add_user_form'/>
            <table border="1" width="100%" class="table_a">
				...
				<tr>
                    <td>邮箱</td>
                    <td>
                        <input type="text" name="email" id='auto_email' aceholder="email..." />
                    </td>
                </tr>
                ...
                <tr>
					...
					<tr>
                    <td>用户详细描述</td>
                    <td><textarea name="mark_up" cols="40" rows="3" placeholder="mark_up..."/></textarea></td>
                </tr>
				<tr>
