                    ...
                    <tr>
                      <?php foreach ($rows as $k => $v):?>
                        ...
                        <tr>
							...
							<td><img src='D:\php25\local\Public\Admin\1_1.c4.jpeg'></td>
                            
                            <td>
                            <!-- index.php/Admin/User/edt/id/12.html -->
                            <?php if ($v['id']>1): ?>
                                <a href="<?php echo U('User/edt', array(id=>$v['id']),false); ?>">修改</a> 
                                <a href="<?php echo U('User/del', array('id' => $v['id']), false);?>">删除</a>
                            <?php  endif; ?>
                            </td>
